...
import Textoeditable from './detalleinfo/textoeditable';
import Crudtexto from './detalleinfo/crudtexto';
        ...
        <>
            <DefaultDashboardLayout>
                        ...
                        <div className="bg-white rounded-bottom smooth-shadow-sm ">
                            <div className="d-flex align-items-center justify-content-between pt-4 pb-2 px-4">
                                <div className="d-flex align-items-center">
                                    ...
                                    <div className="lh-1">
                                        <h3 className="mb-2 text-secondary">FORMULARIO DETALLE INFORMACIÓN</h3>
                ...
                <Row className="mb-8 m-1">
                    {seccionActiva === 'home' && <Textoeditable />}
                    {seccionActiva === 'paginas' && <Crudtexto />}
                </Row>
