                        ...
                        <Card>
                            ...
                            <Card.Body>
                                <div className="mb-4 mb-lg-0">
                                    <h4 className="mb-1 text-secondary">FORMULARIO INFORMACIÓN</h4>
                                    <br />
                                        ...
                                        <tbody>
                                            {filteredMenus.map((fila, index) => (
                                                <tr key={fila.id}>
                                                    ...
                                                    <td>{fila.subMensaje1}</td>
                                                    <td>{fila.subMensaje2}</td>
                                                    <td>
                    ...
                    <Modal size="lg" show={lgShow} onHide={() => setLgShow(false)} aria-labelledby="example-modal-sizes-title-lg" >
                        <Modal.Header closeButton>
                            <Modal.Title id="example-modal-sizes-title-lg">
                                <h4 ><strong>MANTENIMIENTO:</strong> Página Información</h4>
                            </Modal.Title>
                        </Modal.Header>
                        <Modal.Body>
